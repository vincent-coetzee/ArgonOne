...
#define kStringMutexIndex 2
#define kStringConditionIndex 3
#define kStringCountIndex 4
#define kStringExtensionBlockIndex 5
#define kStringFixedSlotCount 6
//
